...
#include <math.h>
#include <stdbool.h>
#include <string.h>   // <-- add this, you use memcpy
#include "vqf.h"
...
/* Provide portable fallbacks if the fast variants aren't supplied */
#ifndef sin_fast
static inline float sin_fast(float x) { return sinf(x); }
#endif
#ifndef cos_fast
static inline float cos_fast(float x) { return cosf(x); }
#endif
#ifndef tan_fast
static inline float tan_fast(float x) { return tanf(x); }
#endif
